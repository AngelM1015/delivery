      ...
      >
        <Marker coordinate={partnerCoords} title="Partner Location">
          <MaterialIcons
            ...
            size={24}
            style={{ padding: 4, borderRadius: 20, backgroundColor: '#fff', color: "red" }}
          />
        </Marker>
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <Animated.View style={[styles.container, { transform: [{ translateY: slideAnim }] }]}>
        {order.status === 'picked_up' && <View style={styles.mapContainer}>{renderMap()}</View>}
              ...
              <View style={styles.chatRow}>
                ...
                <View style={styles.chatIconContainer}>
                  <Ionicons
                    ...
                    color="white"
                    onPress={() =>
                      navigation.navigate('Chat', { conversationId: order.conversation_id })
                    }
                  />
                </View>
              </View>
