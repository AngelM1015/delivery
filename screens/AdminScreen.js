...
const AdminScreen = () => {
  ...
  const orderStats = [
    { name: 'Completed', count: 200, color: 'green', legendFontColor: '#7F7F7F', legendFontSize: 15 },
    { name: 'Pending', count: 50, color: 'yellow', legendFontColor: '#7F7F7F', legendFontSize: 15 },
