  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        We're glad you're excited to use our platform. To enjoy full
        functionality, please sign up.
      </Text>
      <Button
        mode="contained"
        style={styles.button}
      ...
      <Button
        mode="contained"
        style={styles.button}
        onPress={() => navigation.navigate("SignUp", { role: "partner" })}
      >
        Sign Up as Driver
      </Button>
      <Button
        ...
        style={styles.button}
        onPress={() =>
          navigation.navigate("SignUp", { role: "restaurantOwner" })
        }
      >
